...
sn = 10*sin(2*pi*200*t); %+ 5*sin(2*pi*400*t)+7*sin(2*pi*300*t)+5*cos(2*pi*38*t)+ 5*sin(2*pi*120*t)+7*sin(2*pi*378*t)+5*cos(2*pi*265*t)
sn2 = 10*cos(2*pi*200*t);
...
title(sprintf("Freq - %.2f, Valor médio - %.2f, Rms - %.2f, N.Amostras - %.2f, Freq. de amost. - %.2f, Alcance - [%.2f ,%.2f] ", freq, Mean, rms, n, fs,Min, Max));
xlabel("Tempo [s]")
ylabel("Tensão [V]")
