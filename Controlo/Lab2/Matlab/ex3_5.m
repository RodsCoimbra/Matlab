...
gr = -19.173498*log10(f_more)+ 32.7488; %Assintota das altas frequências 
gy = 2.05 + 0*(f_more); %Assintota das baixas frequências
semilogx(f_more,gy, 'r--')
semilogx(f_more,gr,'m--')
%%%%%%%%%%%%%%%

yline(20*log10(Hf_fit_more(1))-3, 'c-') %Curva a menos 3db do fitting original, para descobrir frequência de corte
grid()
